...
项目已完成 Phase 0 / Phase 1 / Phase 2 / Phase 3 / Phase 4 / Phase 5 / Phase 6 的基础工程、真实文件验证、DWG 到 DXF 的本地转换能力、房间文字识别和 label 聚类、房间边界识别、初始房间 JSON 生成、PDF 矢量文字机器校核，以及 PDF 局部截图生成。下一阶段本地 AI 辅助校验的代码入口已完成 dry-run 验证，真实模型调用等待本机 llama.cpp 服务启动。
...
- 当前本地 AI 命令已接入并完成 dry-run，真实本地模型校核等待 llama.cpp 服务启动。
- 当前不做人工校核任务池。
