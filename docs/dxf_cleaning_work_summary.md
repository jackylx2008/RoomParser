...
- `src/room_extractor/cad/dxf_self_cleaner.py`
- `room-extractor self-clean-dxf`
- `python dxf_preparation.py self-clean-dxf`
...
`experiments/dxf_self_clean_experiment.py` 当前支持：
...
room-extractor self-clean-dxf --resume log/dxf_cleaning_experiment --mark-step-accepted <step>
room-extractor self-clean-dxf --resume log/dxf_cleaning_experiment --mark-step-rejected <step>
room-extractor self-clean-dxf --resume log/dxf_cleaning_experiment --write-bloat-audit
room-extractor self-clean-dxf --resume log/dxf_cleaning_experiment --render-step-images
```
...
已验证规则已经整理为正式 reusable cleaner。下一阶段可做：
