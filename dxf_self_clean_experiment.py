"""Self-driving DXF cleaning experiment entry point.
...
Phase 1 supports baseline analysis and exact duplicate linework removal. Later
phases can add rendering, local AI visual checks, invisible entity cleanup, block
cleanup, and near-duplicate cleanup without changing the transaction layout.
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description=(
            "Run an auditable DXF cleaning experiment. The first implementation "
            "supports baseline analysis and exact duplicate linework cleanup."
        )
    )
    ...
    parser.add_argument("--max-steps", type=int, default=1, help="Maximum cleaning steps to run. Default: 1.")
